  ...
  return (
    <group {...props} dispose={null}>
      <Float speed={0.1} floatIntensity={0.1}>
        <Mobile rotation={[0, -Math.PI / 2 + 0.2, 0]} position={[-distance, 0, 0]} scale={3} matcap={param.matcapRose}
      ...
      <Float speed={0.3} floatIntensity={0.1}>
        ...
        <group name='watch' position={[distance, -1, -.5]} scale={2} rotation={[0, -0.2, 0]}>
          <group name='crown'>
            {index === 1 && scrollIndex !== 4 && <Html scale={0.8} center transform wrapperClass='watch-arrow' position={[1.1, 0.5, 1]}>
              <FontAwesomeIcon icon={faCircleChevronUp} onClick={() => setScrollIndex(scrollIndex + 1 > 4 ? scrollIndex : scrollIndex + 1)} />
            </Html>}
            {index === 1 && scrollIndex !== 0 && <Html scale={0.8} center transform wrapperClass='watch-arrow' position={[1.1, -0.5, 1]}>
