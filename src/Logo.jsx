...
import LinkedIn from "./Model/LinkedIn.jsx"
import HalfArc from "./Mesh/HalfArc.jsx"
import DiameterBox from "./Mesh/DiameterBox.jsx"
import RadiusBox from "./Mesh/RadiusBox.jsx"
import SmallBox from "./Mesh/SmallBox.jsx"
    ...
    <>
      ...
      <group {...props} dispose={null}
        ...
        <group ref={Hello} position={[0, posHello, 0]}>
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello1} size={param.diameter * 0.5} position={[-3.2, 0, 0]} text={"H"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello2} size={param.diameter * 0.5} position={[-2.4, 0, 0]} text={"e"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello3} size={param.diameter * 0.5} position={[-1.6, 0, 0]} text={"l"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello4} size={param.diameter * 0.5} position={[-1.3, 0, 0]} text={"l"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello5} size={param.diameter * 0.5} position={[-1, 0, 0]} text={"o"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello6} size={param.diameter * 0.5} position={[-0.2, 0, 0]} text={"!"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello7} size={param.diameter * 0.5} position={[0.6, 0, 0]} text={"I"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello8} size={param.diameter * 0.5} position={[1.1, 0, 0]} text={"a"} />
          <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={Hello9} size={param.diameter * 0.5} position={[2, 0, 0]} text={"m"} />
        </group>

        <group ref={Intro} position={[0, posIntro, 0]}>
          <group ref={IntroKO} visible={true}>
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO1} size={param.diameter * 0.5} position={[-6.3, 0, 0]} text={"f"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO2} size={param.diameter * 0.5} position={[-5.7, 0, 0]} text={"r"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO3} size={param.diameter * 0.5} position={[-5.05, 0, 0]} text={"o"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO4} size={param.diameter * 0.5} position={[-4.1, 0, 0]} text={"m"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO5} size={param.diameter * 0.5} position={[-2.2, 0, 0]} text={"S"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO6} size={param.diameter * 0.5} position={[-1.3, 0, 0]} text={"o"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO7} size={param.diameter * 0.5} position={[-0.3, 0, 0]} text={"u"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO8} size={param.diameter * 0.5} position={[0.65, 0, 0]} text={"t"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO9} size={param.diameter * 0.5} position={[1.3, 0, 0]} text={"h"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO10} size={param.diameter * 0.5} position={[2.7, 0, 0]} text={"K"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO11} size={param.diameter * 0.5} position={[3.55, 0, 0]} text={"o"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO12} size={param.diameter * 0.5} position={[4.5, 0, 0]} text={"r"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO13} size={param.diameter * 0.5} position={[5.2, 0, 0]} text={"e"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroKO14} size={param.diameter * 0.5} position={[6.2, 0, 0]} text={"a"} />
          </group>
          <group ref={IntroEN} visible={true}>
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN1} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-7.2, 0, 0]} text={"c"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN2} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-6.2, 0, 0]} text={"r"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN3} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-5.5, 0, 0]} text={"e"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN4} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-4.5, 0, 0]} text={"a"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN5} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-3.4, 0, 0]} text={"t"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN6} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-2.7, 0, 0]} text={"i"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN7} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-2.2, 0, 0]} text={"v"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN8} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-1.4, 0, 0]} text={"e"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN9} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[-0.1, 0, 0]} text={"d"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN10} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[0.9, 0, 0]} text={"e"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN11} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[1.8, 0, 0]} text={"v"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN12} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[2.7, 0, 0]} text={"e"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN13} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[3.7, 0, 0]} text={"l"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN14} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[4.2, 0, 0]} text={"o"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN15} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[5.1, 0, 0]} text={"p"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN16} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[6.2, 0, 0]} text={"e"} />
            <Typo font={"Poppins_Light"} matcap={matcapTexture} ref={IntroEN17} size={param.diameter * 0.5} rotation={[Math.PI / 2, 0, 0]} opacity={0} position={[7.2, 0, 0]} text={"r"} />
          </group>
        </group>

        <group ref={logo}>
          <group ref={logoMove}>
            <HalfArc ref={TopArcHalf} position={[posKO, param.diameter / 2, 0]} />
            <HalfArc ref={TopArcHalfS} position={[posKO, param.diameter / 2, 0]} />
            <HalfArc ref={BtmArcHalfS} position={[posKO, -param.diameter / 2, param.height]} rotation={[0, Math.PI, Math.PI]} />
            <HalfArc ref={BtmArcHalf} position={[posKO, -param.diameter / 2, 0]} rotation={[0, 0, Math.PI]} />
          </group>

          <group ref={logoKO}>
            <DiameterBox ref={soon} position={[-param.diameter - param.space * 1.5, 0, 0]} scale={[1, 1, 1]} />
            <RadiusBox ref={soon1} position={[posKO, param.space / 2, 0]} rotation={[0, 0, -Math.PI / 2]} scale={[1, 1, 1]} />

            <HalfArc position={[posG, param.diameter / 2, 0]} />
            <HalfArc position={[posG, param.diameter / 2, 0]} rotation={[0, 0, Math.PI]} />
            <SmallBox ref={eoTop} position={[posG + param.innerRadius, param.outerRadius + param.space * 1.5, 0]} scale={[1, 1, 1]} />
            <SmallBox ref={eoBtm} position={[posG + param.innerRadius, param.innerRadius - param.space * 1.5, 0]} scale={[1, 1, 1]} />
            <DiameterBox ref={eo1} position={[posG + param.outerRadius + param.space * 1.5, param.diameter, 0]} rotation={[0, 0, -Math.PI / 2]} scale={[1, 1, 1]} />
            <HalfArc ref={youngArcTop} position={[posG + param.space * 2, -param.diameter / 2, 0]} />
            <HalfArc ref={youngArcBtm} position={[posG + param.space * 2, -param.diameter / 2, 0]} rotation={[0, 0, Math.PI]} />
          </group>

          <group ref={logoEN} >
            <HalfArc ref={n1Arc} position={[posKO, param.diameter / 2, 0]} />
            <RadiusBox ref={n1StemL} position={[-param.diameter - param.space, param.diameter / 2, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} />
            <RadiusBox ref={n1StemR} position={[-param.space, param.diameter / 2, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} />

            <group ref={enU} position={[posU, param.diameter / 2, 0]} >
              <HalfArc ref={uArc} position={[0, 0, 0]} rotation={[0, 0, 0]} visible={false} />
              <RadiusBox ref={uStemL} position={[-param.diameter / 2, 0, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} visible={false} />
              <RadiusBox ref={uStemR} position={[param.diameter / 2, 0, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} visible={false} />
            </group>

            <HalfArc ref={n2Arc} position={[posN, param.diameter / 2, 0]} visible={false} />
            <RadiusBox ref={n2StemL} position={[posN - param.diameter / 2, param.diameter / 2, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} visible={false} />
            <RadiusBox ref={n2StemR} position={[posN + param.diameter / 2, param.diameter / 2, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} visible={false} />

            <HalfArc ref={o1ArcTop} position={[posO1, param.diameter / 2, 0]} visible={false} />
            <HalfArc ref={o1ArcBtm} position={[posO1, param.diameter / 2, 0]} rotation={[0, 0, 0]} visible={false} />

            <HalfArc ref={o2ArcTop} position={[posO2, param.diameter / 2, 0]} visible={false} />
            <HalfArc ref={o2ArcBtm} position={[posO2, param.diameter / 2, 0]} rotation={[0, 0, 0]} visible={false} />

            <HalfArc ref={o3ArcTop} position={[posO3, param.diameter / 2, 0]} visible={false} />
            <HalfArc ref={o3ArcBtm} position={[posO3, param.diameter / 2, 0]} rotation={[0, 0, 0]} visible={false} />

            <group ref={enY} position={[posY, param.diameter / 2, 0]}>
              <HalfArc ref={yArcTop} position={[0, 0, 0]} rotation={[0, 0, 0]} visible={false} />
              <RadiusBox ref={yStemL} position={[param.diameter / 2, 0, 0]} scale={[0, 1, 1]} rotation={[0, 0, -Math.PI / 2]} visible={false} />
            </group>
            <RadiusBox ref={yStemR} position={[posY + param.diameter / 2, -param.diameter / 2, 0]} scale={[0, 1, 1]} rotation={[0, 0, Math.PI / 2]} visible={false} />
            <HalfArc ref={yArcBtm} position={[posY, -param.diameter / 2, 0]} rotation={[0, 0, Math.PI]} visible={false} />
          </group>
        </group>
      </group>
    </>
